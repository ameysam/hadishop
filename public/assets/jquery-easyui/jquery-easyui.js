		...
		function initCss(){
			if (!$('#datagrid-filter-style').length){
				$('head').append(
					...
					'a.datagrid-filter-btn{padding:4px 4px;display:inline-block;width:22px;height:22px;margin:0;vertical-align:top;cursor:pointer;opacity:0.6;filter:alpha(opacity=60);float:left;}' +
...
if ($.fn.datagrid){
	$.fn.datagrid.defaults.loadMsg = ' لطفا کمی صبرکنید...';
}
if ($.fn.treegrid && $.fn.datagrid){
	$.fn.treegrid.defaults.loadMsg = $.fn.datagrid.defaults.loadMsg;
}
if ($.messager){
	$.messager.defaults.ok = 'بلی';
...
if ($.fn.validatebox){
	$.fn.validatebox.defaults.rules.email.message = 'لطفا ایمیل صحیح وارد نمایید.';
	$.fn.validatebox.defaults.rules.url.message = 'Please enter a valid URL.';
	$.fn.validatebox.defaults.rules.length.message = 'Please enter a value between {0} and {1}.';
	$.fn.validatebox.defaults.rules.remote.message = 'لطفا این فیلد را اصلاح نمایید.';
	$.fn.validatebox.defaults.missingMessage = 'پر کردن این فیلد اجباری است.';
}
if ($.fn.numberbox){
	$.fn.numberbox.defaults.missingMessage = 'پر کردن این فیلد اجباری است.';
}
if ($.fn.combobox){
	$.fn.combobox.defaults.missingMessage = 'پر کردن این فیلد اجباری است.';
}
if ($.fn.combotree){
	$.fn.combotree.defaults.missingMessage = 'پر کردن این فیلد اجباری است.';
}
if ($.fn.combogrid){
	$.fn.combogrid.defaults.missingMessage = 'پر کردن این فیلد اجباری است.';
}
if ($.fn.calendar){
...
if ($.fn.datebox){
	...
	$.fn.datebox.defaults.missingMessage = 'پر کردن این فیلد اجباری است.';
}
